function [assignments] = get_visual_words(descriptors, vocabulary)
    ...
    for i = 1:n
       d = descriptors(:,i);
       closest_word = get_closest_word(d,vocabulary);
       assignments(:,i) = closest_word;
    end
end


function [closest_word] = get_closest_word(descriptor, vocabulary)
    closest_word = 0;
    smallest_dist = 10000000000;
    v_size = size(vocabulary,2);
    for i = 1:v_size
       visual_word = vocabulary(:,i);
